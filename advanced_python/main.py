...
def run_all_demos():
    ...
    intern = Intern("TES001", "Khushi", "khushi@example.com", "Python", 3)
    print(intern)
    ...
    for certificate in certificate_generator(["Khushi", "Raushan"]):
        print(certificate)
    ...
    print("\n8. Abstract Class")
    print(AttendanceReport("Khushi", 24, 30).generate_report())
    print(PerformanceReport("Khushi", 89).generate_report())
    ...
    print("\n12. Multiprocessing")
    print(generate_reports_for_interns([("Khushi", 89), ("Raushan", 91)]))
    ...
    init_db()
    create_intern("TES001", "Khushi", "khushi@example.com", "Python")
